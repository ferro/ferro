...
html ->
  ...
  body ->
    ...
    p ->
      ...
      code 'chrome://'
      t 'pages, including this one, nor on the Chrome Web Store. It also does not work on pages that have not finished loading and some pages that have their own keyboard shortcuts.'
    h3 'Saved Sessions'
    ul id: 'session-list', ->
    ...
    ul ->
    	...
    	li ->
    	  a href: 'https://chrome.google.com/webstore/detail/ahmiiblnmmnijkhboligioinfchkeagi', -> 'Minimalist for Facebook' #todo
    	li ->
